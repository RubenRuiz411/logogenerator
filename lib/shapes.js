// class for circle which allows input from user prompt then render file
class Circle {
...
// class for triangle which allows input from user prompt then render file
class Triangle {
    constructor(shapecolor,text,textcolor){
        this.shapecolor = shapecolor
        this.text = text
...
// class for square which allows input from user prompt then render file
class Square {
    constructor(shapecolor,text,textcolor){
        this.shapecolor = shapecolor
        this.text = text
...
// allows classes to be used in other file
